...
readonly STABLE_REPO_URL=https://dsys-kubernetes-charts-stable.storage.googleapis.com/
# readonly INCUBATOR_REPO_URL=https://dsys-kubernetes-charts-incubator.storage.googleapis.com/
readonly GCS_BUCKET_STABLE=gs://dsys-kubernetes-charts-stable
# readonly GCS_BUCKET_INCUBATOR=gs://dsys-kubernetes-charts-incubator
